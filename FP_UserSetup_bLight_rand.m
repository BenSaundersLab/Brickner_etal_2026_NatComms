...
loadfilelist = 'TVB_13_14_RandomLightsHab';%name of single loadfile or list of loadfiles(including path)
...
%% Save locations
UserVals.saveloc = ['/Users/meganbrickner/Library/CloudStorage/GoogleDrive-brick225@umn.edu/Shared drives/MeganBrickner2/01_DATA_mab2/TVB Studies/TVB_Cohort4/00_Hab_withLights/IndvAnalysis'];%'G:\Shared drives\LivEngel\Proj_OptoPav\Matlab'];%path to folder to save mat files and figures to - if empty ([]) saves to location of raw data
...
UserVals.signallabel = 'BLA_dLight'; %name of signal type used in plotting
UserVals.N = 25; %multiplicative for downsampling (100 = ~10hz, 25 = ~40Hz) 

%UserVals.eventtypes = {'ThreePump','ActivePE', 'APEDur', 'InactivePE', 'IPEDur','OnePump','FivePump','SevenPump'}; %cuediscrim and hablabels for PC channels including any to be generated as part of option analyses below
%UserVals.eventtypes = {'Shock'};
%UserVals.eventtypes = {'Stim'};
UserVals.eventtypes = {'Lights'};
...
%VBN RandRew
%UserVals.setcond.RPEFIRST = {[2 1],{'RP', 'NCP'},'first',[1],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.PE = {2, {'PE'},'none',[],[2,10]};
%UserVals.setcond.PUMP = {1, {'Rew'},'none',[],[5,10],{[0 3]},{'rewarddel'}};

%UserVals.setcond.ThreePUMP = {1, {'ThreePUMP'},'none',[],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.APE = {2, {'ACTIVEPE'},'none',[],[2,4]};
%UserVals.setcond.IPE = {4, {'INACTIVEPE'},'none',[],[2,4]};
%UserVals.setcond.OnePUMP = {6, {'OnePUMP'},'none',[],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.FivePUMP = {7, {'FivePUMP'},'none',[],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.SevenPUMP = {8, {'SevenPUMP'},'none',[],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.OneRPEFIRST = {[2 6],{'RP', 'NCP'},'first',[1],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.ThreeRPEFIRST = {[2 1],{'RP', 'NCP'},'first',[1],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.FiveRPEFIRST = {[2 7],{'RP', 'NCP'},'first',[1],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
%UserVals.setcond.SevenRPEFIRST = {[2 8],{'RP', 'NCP'},'first',[1],[2,10],{[0 1],[0 3],[0 5],[0 7],[1 10]},{'onesec','threesec','fivesec','sevensec','tensec'}};
